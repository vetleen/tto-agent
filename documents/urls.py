...
urlpatterns = [
    ...
    path("<uuid:project_id>/chat/threads/<uuid:thread_id>/delete/", views.thread_delete, name="thread_delete"),
    path("<uuid:project_id>/chat/threads/<uuid:thread_id>/archive/", views.thread_archive, name="thread_archive"),
