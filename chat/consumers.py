...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def _handle_slides_set_theme(self, data):
        ...
        def _apply():
            ...
            if resolved is None and name == "org":
                # Back-compat for the pre-v2 picker's "org" tile. Preset names
                # need no special case: they're built-in theme ids now.
    ...
    def _resolve_preferences(self):
        ...
        # effect without a reconnect; self.user lives as long as the WebSocket,
    ...
    def _check_budget_exceeded(self) -> dict | None:
        ...
        # memos (see _resolve_preferences) and read live.
        invalidate_membership_cache(self.user)
        invalidate_user_preferences_cache(self.user)
